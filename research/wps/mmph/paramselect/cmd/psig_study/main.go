...
import (
	"Thesis/bits"
	bucket "Thesis/research/wps/mmph/relative_trie"
	"Thesis/research/wps/mmph/paramselect"
	"Thesis/research/wps/trie/zft"
	"encoding/csv"
	"flag"
	"fmt"
	"math"
...
func main() {
	var (
		outPath    = flag.String("out", "mmph/relative_trie/study/data/results.csv", "Output CSV path")
