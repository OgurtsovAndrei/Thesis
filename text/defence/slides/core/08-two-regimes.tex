\begin{frame}{Two Regimes: Dense Clusters and Sparse Tails}
    \begin{columns}[T,onlytextwidth]
        ...
        \textbf{Dense cluster} ($U' = k_{\max} - k_{\min} < \frac{n \mathcal{L}}{\varepsilon}$)
        \smallskip
        ...
        \begin{center}
            \fbox{$\;U' \le n\mathcal{L}/\varepsilon
                    \;\Longrightarrow\; \text{exact mode,}\ \mathrm{FPR} = 0\;$}\\[0.3em]
        ...
        \begin{itemize}\setlength{\itemsep}{0.2em}
            \item LP hash:\quad $\log_2(\mathcal{L}/\varepsilon)$ BPK
