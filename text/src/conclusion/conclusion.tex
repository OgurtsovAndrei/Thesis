...
\begin{itemize}
    ...
    $13$--$30\times$ at LSM bucket sizes.
...
\begin{itemize}
    ...
    \item \textbf{170--400\,ns} per query across all four SOSD
...
\begin{itemize}
    ...
    Seg-ARE reaches $\mathrm{FPR} < 10^{-8}$ at $\sim\!6$ BPK against Grafite's
...
(Wiki-like, Facebook-trace-style burst patterns) and stays harmless on the rest.
