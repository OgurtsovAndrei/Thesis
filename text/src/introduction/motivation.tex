...
its answer may be a false positive with probability $\leq \varepsilon$, while false negatives are forbidden.
...
under the same false-positive guarantee.
...
suffixes outperforms WPS at the bucket sizes that arise at per-SSTable
scale on both axes ---
$59$~bits per key of auxiliary metadata removed and per-query latency
reduced by $13$--$30\times$ relative to WPS.
